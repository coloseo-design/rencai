 ...
 */
class admin_gqtask_controller extends siteadmin_controller{
    ...
    function index_action(){
        ...
        if($pages['total'] > 0){
         ...
         $this->siteadmin_tpl(array('admin_gqtask_list'));
    ...
    function delgqtask_action(){
     ...
     public function details_action(){
        ...
        $this->siteadmin_tpl(array('admin_gqtask_details'));
    ...
    public function show_action(){
        ...
        if($_GET['id']){
         ...
         $this->siteadmin_tpl(array('admin_gqtask_show'));
    }
    ...
    public  function  statis_action(){
        ...
        if($id){
            ...
            $return                     =               $gqdemandM -> upGqtaskStatus($where,$updata);
