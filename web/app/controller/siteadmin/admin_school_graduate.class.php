 ...
 */
class admin_school_graduate_controller extends siteadmin_controller{
	//设置高级搜索功能
	function set_search(){
	...
	function index_action(){
      ...
      if($state==2){
        ...
        $this -> siteadmin_tpl(array('admin_school_graduate'));
	...
	function status_action(){
        ...
        $nid?$this->ACT_layer_msg("职位审核(ID:".$id.")设置成功！",9,$_SERVER['HTTP_REFERER'],2,1):$this->ACT_layer_msg("设置失败！",8,$_SERVER['HTTP_REFERER']);    
