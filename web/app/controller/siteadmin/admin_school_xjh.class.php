 ...
 */
class admin_school_xjh_controller extends siteadmin_controller{
	//设置高级搜索功能
	function set_search(){
	...
	function index_action(){
      ...
      if($status==4){
		...
		$this->siteadmin_tpl(array('admin_school_xjh'));
	}
	...
	function listxjh_action(){
		...
		$this->siteadmin_tpl(array('admin_school_listxjh'));
	}
	...
	function add_action(){
		...
		$this -> siteadmin_tpl(array('admin_school_xjhadd'));
	}
	//详情及修改
