...
class admin_question_controller extends siteadmin_controller{
	...
	function get_class_action(){
		...
		if($_POST['pid']){
			...
			$q_class	=	$AskM -> getQclassList(array('pid'=>$_POST['pid'],'orderby'=>'sort,desc'),'id,name,pid');
	...
	function status_action(){
		...
		if(is_array($id)){
			...
			$nid?$this -> ACT_layer_msg("问答审核(ID:".$_POST['aid'].")设置成功！",9,$_SERVER['HTTP_REFERER'],2,1):$this -> ACT_layer_msg("设置失败！",8,$_SERVER['HTTP_REFERER']);
