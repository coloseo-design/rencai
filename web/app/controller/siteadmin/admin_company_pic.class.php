 ...
 */
class admin_company_pic_controller extends siteadmin_controller
{
    ...
    function index_action()
    {
        ...
        $ListNew                    =   $CompanyM -> getList($where,array('field'=>'uid,name,logo,logo_status','logo'=>'1'));
        
        $this   ->  yunset(array('rows' => $ListNew['list']));

        $this   ->  siteadmin_tpl(array('admin_company_pic'));
    }
    ...
    function show_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_company_picshow'));
    }
    ...
    function banner_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_company_picbanner'));
