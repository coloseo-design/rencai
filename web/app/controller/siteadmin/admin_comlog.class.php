 ...
 */
class admin_comlog_controller extends siteadmin_controller{
    ...
    function index_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_useridjob'));
    ...
    function useridmsg_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_useridmsg'));
    ...
    {   
        ...
        $this->siteadmin_tpl(array('admin_lookjob'));
    ...
    function partapply_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_partapply'));
    }
    ...
    function talentpool_action()
    {
        ...
        $this->siteadmin_tpl(array('admin_talentpool'));
    }
