...
class whb_model extends model
{
    ...
    */
    ...
    private function getJobInfo($where, $data)
    {
    ...
    private function getJobList($where, $data)
    {
    ...
    function getComHb($data = array())
    {
        ...
        if (!empty($data)) {
            ...
            $com        =   $this->getComInfo($comId, array('field' => 'uid, name, shortname, logo, mun, hy', 'logo' => 1, 'hb' => 1));
            ...
            if (!empty($com) && is_array($com)) {
                ...
                foreach ($jobs as $jk => $jv) {
                    ...
                    if (strlen($jv['name']) > 24){

                        $jv['name']     =   mb_substr($jv['name'].$jv['name'], 0, 8, 'utf-8').'...';
                    }
                    if ($jk == 0){
                        $jobOneName =   $jv['name'];
                        $jobOneXZ =   $jv['job_salary'];
                    }
                    if ($jk == 1){
                        $jobTwoName =   $jv['name'];
                        $jobTwoXZ =   $jv['job_salary'];
                    }
                    if ($jk == 2){
                        $jobThreeName =   $jv['name'];
                        $jobThreeXZ =   $jv['job_salary'];
                    }
                    if ($jk == 3){
                        $jobFourName =   $jv['name'];
                        $jobFourXZ =   $jv['job_salary'];
                    }
                    if ($jk == 4){
                        $jobFiveName =   $jv['name'];
                        $jobFiveXZ =   $jv['job_salary'];
                    }
                    if ($jk == 5){
                        $jobSixName =   $jv['name'];
                        $jobSixXZ =   $jv['job_salary'];
                    }
                }
