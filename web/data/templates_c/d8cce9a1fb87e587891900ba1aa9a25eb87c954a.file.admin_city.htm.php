<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-21 15:58:22
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\admin\admin_city.htm" */ ?>
<?php /*%%SmartyHeaderCode:1737162d9071e8c6ee4-90033449%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8cce9a1fb87e587891900ba1aa9a25eb87c954a' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\admin\\admin_city.htm',
      1 => 1634883866,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1737162d9071e8c6ee4-90033449',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62d9071e9f8c35_23019116',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62d9071e9f8c35_23019116')) {function content_62d9071e9f8c35_23019116($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
" style="display:" <?php if (($_smarty_tpl->tpl_vars['key']->value+1)%2=='0') {?>class="admin_com_td_bg"<?php }?>>
				            		<td class="ud" align="center">
										<input lay-ignore type="checkbox" class="checkbox_all" name="checkbox_all" value="<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
">
									</td>
				            		<td class="ud">
										<input type="text" name="citysort_<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
" id="citysort_<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['city_row']->value['sort'];?>
" class="input-text  citysort">
									</td>
				            		<td class="ud">
...
','2','parent');">
				            		...
				            		<td class="ud">
										<input class="input-text" type="text" id="citye_name_<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
...
">
				            		...
				            		<td class="ud">
				            			<input class="layui-btn layui-btn-normal" type="button" name="update" value="更新" onClick="checkedtr('<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
');"/>
				            			<a class="layui-btn layui-btn-primary" href="javascript:;" onClick="delsingle('<?php echo $_smarty_tpl->tpl_vars['city_row']->value['id'];?>
','1')">删除</a>
				            		</td>
				          		</tr>
				          		<?php } ?>
