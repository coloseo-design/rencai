<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-08 16:23:05
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\admin\admin_school_graduate.htm" */ ?>
<?php /*%%SmartyHeaderCode:702762c7e969b547a0-86756256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29aa936bf66225fabfa170752d9bdf5e73598def' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\admin\\admin_school_graduate.htm',
      1 => 1634883866,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '702762c7e969b547a0-86756256',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62c7e969c912c8_98061978',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62c7e969c912c8_98061978')) {function content_62c7e969c912c8_98061978($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include 'D:\\wwwroot\\rencai_lygki7\\web\\app\\include\\libs\\plugins\\function.searchurl.php';
...
function checkstate(id,state){
	...
	$.post("index.php?m=admin_school_graduate&c=checkstate",{id:id,state:state,pytoken:pytoken},function(data){
		if(data==1){
			if(state=='1'){
...
$(function(){
    ...
    if(rstatus!=1){
        if(rstatus==2){
          ...
          $("#plstatus" + rstatus).attr("checked", true);
			    $("#job_status").attr("checked",false);
			    $.layer({
			      type: 1,
			      title: '审核操作',
			      closeBtn: [0, true],
      ...
      var pytoken=$("#pytoken").val();
      $.post("index.php?m=admin_school_graduate&c=lockinfo",{id:id,pytoken:pytoken},function(msg){
	...
	$(".xuanshang").click(function(){
		...
		if(xstime){
			...
			add_class('职位置顶','300','220','#infobox3','');
		}
	...
	$(".urgent").click(function(){
		...
		if(eurgent){
			...
			$(".eurgentdiv").show();
			add_class('紧急招聘','290','270','#infobox5','');
		}else{
			add_class('紧急招聘','290','240','#infobox5','');
		} 
	});
	$(".rec").click(function(){
		$("input[name=pid]").val($(this).attr("pid"));
		...
		if(edate){
			$(".edate").html(edate);
			$(".edatediv").show();
			add_class('职位推荐','290','270','#infobox6','');
		}else{
...
function Refresh(){//批量刷新
	...
	if(codewebarr==""){
		...
		loadlayer();
		$.post("index.php?m=admin_school_graduate&c=refresh",{ids:codewebarr,pytoken:$('#pytoken').val()},function(data){
	...
	<body class="body_ifm">
		<div id="preview" style="display:none;width:450px ">
			<div style="height:380px; overflow:auto;width:450px;">
				<form class="layui-form" action="index.php?m=admin_school_graduate&c=cjobstatus" target="supportiframe" method="post"
...
">
					...
					<table cellspacing='1' cellpadding='1' class="admin_examine_table">
						...
						<tr>
							<th></th>
							<td align="left">
								<div class="sh_sm">当前职位根据企业审核（除了未通过）同步审核</div>
							</td>
						</tr>
						<tr>
							<th width="80">职位审核：</th>
							<td align="left">
								<div class="layui-form-item">
									<div class="layui-input-inline">
										<input name="job_status" id="job_status" value="1" title="同步" type="checkbox" lay-skin="primary" checked="checked"
										 disabled="disabled" />
		...
		<div id="export" style="display:none;">
			<div class="" style=" margin-top:10px; ">
				<div>
					<form action="index.php?m=admin_school_graduate&c=xls" target="supportiframe" method="post" id="formstatus" class="myform">
...
">
		...
		<div id="infobox5" style="display:none;text-align:center;">
			<div class="admin_com_t_box">
				<form action="index.php?m=admin_school_graduate&c=urgent" target="supportiframe" method="post" id="formstatus">
					<input type="hidden" name="pytoken" id="pytoken" value="<?php echo $_smarty_tpl->tpl_vars['pytoken']->value;?>
">
					...
					<div class="eurgentdiv" style="display:none"> <span class="admin_com_smbox_span">当前结束日期：</span> <span class="admin_com_smbox_list_s eurgent"
						 style="color:#f60"></span> </div>
		...
		<div id="infobox6" style="display:none;">
			<div class="admin_com_t_box">
				<form action="index.php?m=admin_school_graduate&c=recommend" target="supportiframe" method="post" id="formstatus">
					<input type="hidden" name="pytoken" value="<?php echo $_smarty_tpl->tpl_vars['pytoken']->value;?>
">
					...
					<div class=" admin_com_smbox_list_pd"> <span class="admin_com_smbox_span">推荐天数：</span>
						<input class="admin_com_smbox_text" value="" name="addday" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')">
						<span class="admin_com_smbox_list_s">天</span> </div>
					<div class="edatediv" style="display:none"> <span class="admin_com_smbox_span">当前结束日期：</span> <span class="admin_com_smbox_list_s edate"
						 style="color:#f60"></span> </div>
		...
		<div id="status_div" style="display:none; width: 390px; ">
			<form action="index.php?m=admin_school_graduate&c=status" target="supportiframe" method="post" class="layui-form"
...
">
		...
		<div id="infobox3" style="display:none;text-align:center;margin-top:20px">
			<form action="index.php?m=admin_school_graduate&c=xuanshang" target="supportiframe" method="post" id="formstatus"
			 class="xssubmit">
				<input type="hidden" name="pytoken" value="<?php echo $_smarty_tpl->tpl_vars['pytoken']->value;?>
">
				<div class=" admin_com_smbox_list_b"> <span class="admin_com_smbox_span">置顶天数：</span>
					...
					<span class="admin_com_smbox_list_s">天</span> </div>
				<div class="xsdiv" style="display:none"> <span class="admin_com_smbox_span">当前结束日期：</span> <span class="admin_com_smbox_list_s xsdate"
					 style="color:#f60"></span> </div>
		...
		<div id="infobox2" style="display:none;">
			<div class="admin_com_t_box">
				<form action="index.php?m=admin_school_graduate&c=ctime" target="supportiframe" method="post" id="formstatus">
					<input type="hidden" name="pytoken" value="<?php echo $_smarty_tpl->tpl_vars['pytoken']->value;?>
">
		...
		<div id="infobox4" style="display:none;">
			<div class="admin_com_t_box_hy">
				<form action="index.php?m=admin_school_graduate&c=saveclass" target="supportiframe" method="post" id="formstatus"
				 onSubmit="return checkmove();">
					<input type="hidden" name="pytoken" value="<?php echo $_smarty_tpl->tpl_vars['pytoken']->value;?>
">
...
" />
						...
						<div class="admin_Filter_text formselect" did='dtype'>
							<input type="button" value="<?php if ($_GET['type']=='1') {?>公司名称<?php } else { ?>职位名称<?php }?>" class="admin_new_select_text"
							 id="btype">
...
" name='type'>
			...
			<div class="tty_table-bom">
				<div class="admin_statistics">
					...
					<a href="index.php?m=admin_school_graduate" class="ajaxjoball">0</a>；
					未审核：<a href="index.php?m=admin_school_graduate&state=4" class="ajaxjobstatus1">0</a>；
					未通过：<a href="index.php?m=admin_school_graduate&state=3" class="ajaxjobstatus2">0</a>；
					已下架：<a href="index.php?m=admin_school_graduate&status=1" class="ajaxjobstatus3">0</a>；
				...
				<div class="table-list">
					<div class="admin_table_border">
						...
						<form action="index.php" name="myform" method="get" id='myform' target="supportiframe">
							<input name="m" value="admin_school_graduate" type="hidden" />
							...
							<table width="100%">
								<thead>
									<tr class="admin_table_top">
										...
										<th><a href="<?php echo smarty_function_searchurl(array('order'=>'desc','t'=>'id','m'=>'admin_school_graduate','untype'=>'order,t'),$_smarty_tpl);?>
">编号<img src="images/sanj.jpg" /></a></th>
										<?php } else { ?>
										<th><a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'id','m'=>'admin_school_graduate','untype'=>'order,t'),$_smarty_tpl);?>
...
" class="check_all" name="del[]" onclick="unselectall()"
											 rel="del_chk" style="margin-left:5px;"></td>
										...
										<td class="ud" align="left" width="210">
											<div class="admin_jobname"> <a href="<?php echo smarty_function_url(array('m'=>'job','c'=>'comapply','id'=>$_smarty_tpl->tpl_vars['v']->value['id'],'look'=>'admin'),$_smarty_tpl);?>
...
" target="_blank" class="admin_cz_sc"><?php echo $_smarty_tpl->tpl_vars['v']->value['com_name'];?>
										...
										<td class="td" align="center"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['sdate'],"%Y-%m-%d %H:%M");?>
...
','2');">已下架</span>
											<?php } else { ?> <span class="admin_com_Audited" onclick="checkstate('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
','1');">发布中</span>
											<?php }?> </td>
										<td>
											<div class="admin_new_t_j">置顶： <a href="javascript:void(0);" pid="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
" class="admin_new_tg <?php if ($_smarty_tpl->tpl_vars['v']->value['xsdate']>time()) {?>admin_new_tg_cur<?php }?> xuanshang"></a>
											...
											<div class="admin_new_t_j">推广：
												<?php if ($_smarty_tpl->tpl_vars['v']->value['rec_time']>time()) {?> <a href="javascript:void(0);" class="admin_new_tg admin_new_tg_cur rec"
...
"></a>
												<?php } else { ?> <a href="javascript:void(0);" class="admin_new_tg rec" pid="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
"></a>
												<?php }?></div>
											<div class="admin_new_t_j">紧急：
												<?php if ($_smarty_tpl->tpl_vars['v']->value['urgent_time']>time()) {?> <a href="javascript:void(0);" class="admin_new_tg admin_new_tg_cur urgent"
												 pid="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
"></a>
												<?php } else { ?> <a href="javascript:void(0);" class="admin_new_tg urgent" pid="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
"></a>
												<?php }?> </div>
										</td>
										<td>
...
' class="admin_new_c_bth admin_new_c_bthsh status">审核</a>
												<a href="index.php?m=admin_school_graduate&c=matching&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="admin_new_c_bth admin_new_c_bth_pp">匹配</a>
											</div>
											<div class="admin_new_bth_c"> <a href="index.php?m=admin_school_graduate&c=show&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="admin_new_c_bth ">修改</a>
												<a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=admin_school_graduate&c=del&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
');"
