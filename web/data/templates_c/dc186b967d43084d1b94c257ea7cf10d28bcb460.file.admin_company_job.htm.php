<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-21 15:39:45
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\admin\admin_company_job.htm" */ ?>
<?php /*%%SmartyHeaderCode:1826162d902c1c72d04-04037278%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc186b967d43084d1b94c257ea7cf10d28bcb460' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\admin\\admin_company_job.htm',
      1 => 1644196793,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1826162d902c1c72d04-04037278',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62d902c1ed6ea7_89483161',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62d902c1ed6ea7_89483161')) {function content_62d902c1ed6ea7_89483161($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include 'D:\\wwwroot\\rencai_lygki7\\web\\app\\include\\libs\\plugins\\function.searchurl.php';
				...
				<form class="layui-form">
					...
					<table cellspacing='1' cellpadding='1' class="admin_examine_table">
						...
						<tr>
							...
							<td align="left">
								<div>
									<a id="twtask_urgent_tag" href="javascript:void(0);" onclick="twTaskTag('twtask_urgent');" class="twtask_urgent_y">是否加急</a>
									<a id="twtask_wcmoments_tag" href="javascript:void(0);"  onclick="twTaskTag('twtask_wcmoments');" class="twtask_wcmoments_y">是否发送到朋友圈</a>
...
">
						...
						<div class="admin_resume_dc">
							...
							<label><span class="admin_resume_dc_s"> <input type="checkbox" class="type" name="type[]" value="zp_num">招聘人数</span></label>
							...
							<label><span class="admin_resume_dc_s"> <input type="checkbox" class="type" name="type[]" value="zp_minage,zp_maxage">年龄要求</span></label>
			...
			function checkstate(id, state) {
				...
				$.post("index.php?m=admin_company_job&c=checkstate", {
					...
					if (data == 1) {
						if (state == '1') {
							$('#state' + id).html(
								'<span class="admin_com_noAudited">已下架</span><a href="javascript:void(0);" onclick="checkstate(\'' + id +
								'\',\'2\');" class="admin_new_tg"></a>');
						} else {
							$('#state' + id).html(
