<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-21 16:00:54
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\member\user\server.htm" */ ?>
<?php /*%%SmartyHeaderCode:1992462d907b6931473-77373091%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f143480389a781c17d2da4b0e69083f600e2538f' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\member\\user\\server.htm',
      1 => 1634883847,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1992462d907b6931473-77373091',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62d907b69ab345_73739750',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62d907b69ab345_73739750')) {function content_62d907b69ab345_73739750($_smarty_tpl) {?><!--委托简历弹出层-->
...
')">30天</span>
			...
			<div>
				...
				<input type="hidden" id="myxs" name="myxs" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['integral_resume_top'];?>
">
				<input type="hidden" id="mywt" name="mywt" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['pay_trust_resume'];?>
">
				...
				<form name="alipayment" id="payform_user" action="../api/alipay/alipayto.php" method="post" target="_blank" onsubmit="return pay_forms();">
					<div style="padding:10px 0 0 0;overflow: hidden;">
						...
						<div class="job_redpack_pay">
							<a href="javascript:;" onclick="serverPay('wxpay');">
								<div class="job_redpack_pay_bor"><img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
/images/wx_pay.png"></div>
								<div class="job_redpack_pay_p">微信支付</div>
							</a>
						</div>
						<?php }?>
	...
	$('#pay_type').val(pay_type);
 	var resumeid = $('#server_eid').val();
  	...
  	$.ajax({
        ...
        global:false,
        url: "index.php?c=resume&act=resumeOrder",  
        data: {wteid:resumeid,paytype:pay_type},  
        success: function(data){  
          layer.close(index);
        	var data=eval('('+data+')'); 
        	if(data.error==1){
...
<div id="wxpayTx" style="display:none;">
	<div class="wx_payment">
		...
		<div class="wx_payment_h2">二维码有效时长2小时，请尽快支付</div>
