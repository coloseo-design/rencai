<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-21 17:31:42
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\admin\admin_tongji_downresume.htm" */ ?>
<?php /*%%SmartyHeaderCode:1259262d91cfe9fcea7-59880519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8df84c6c8d25666cfd2438ab6ce0d9aa758139d6' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\admin\\admin_tongji_downresume.htm',
      1 => 1636510354,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1259262d91cfe9fcea7-59880519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62d91cfeaf7030_19702108',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62d91cfeaf7030_19702108')) {function content_62d91cfeaf7030_19702108($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\wwwroot\\rencai_lygki7\\web\\app\\include\\libs\\plugins\\function.url.php';
...
<div class="infoboxp">
	...
	<div class="admin_tj_show">
        <div class="admin_statistics">
            ...
            <em class="admin_statistics_s">简历被下载次数：
        ...
        <div class="admin_tongji_box">
    	    ...
    	    <div class="admin_udbox">
        	    <div class="admin_tj_udtit">简历被下载次数排行</div>
                <div class="admin_udbox_list">
        	        <?php  $_smarty_tpl->tpl_vars['rlist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['rlist']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['toplist']->value['resume']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
            	        <div class="admin_udbox_list_resume">
                            <div class="admin_udbox_list_resume_name"> 
                                <a href='<?php echo smarty_function_url(array('m'=>'resume','c'=>'show','id'=>$_smarty_tpl->tpl_vars['rlist']->value['eid']),$_smarty_tpl);?>
' target="_blank"><?php echo $_smarty_tpl->tpl_vars['rlist']->value['name'];?>
</a>
                            </div>
            	            下载次数：<?php echo $_smarty_tpl->tpl_vars['rlist']->value['count'];?>
            ...
            <div class="admin_udbox_right">
        	    <div class="admin_tj_udtit">企业下载简历数排行</div>
                <div class="admin_udbox_list">
        	       <?php  $_smarty_tpl->tpl_vars['clist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['clist']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['toplist']->value['company']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['clist']->key => $_smarty_tpl->tpl_vars['clist']->value) {
$_smarty_tpl->tpl_vars['clist']->_loop = true;
?>
                    <div class="admin_udbox_list_resume">
        	            <div class="admin_udbox_list_resume_name">
                            <a href='<?php echo smarty_function_url(array('m'=>'company','c'=>'show','id'=>$_smarty_tpl->tpl_vars['clist']->value['uid']),$_smarty_tpl);?>
' target="_blank"><?php echo $_smarty_tpl->tpl_vars['clist']->value['name'];?>
</a>
                        </div>
        	            下载数：<?php echo $_smarty_tpl->tpl_vars['clist']->value['count'];?>
            ...
            <div class="admin_udbox_table_bor">
                <div class="admin_udbox_table_box">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="admin_udbox_table">
                        <tr>
                            <td>
                            	<div class="admin_atatic_chart" id="hytj" style="width:500px;height:300px; margin:0 auto"></div>
                            </td>
                            <td class="admin_atatic_chart_tdbor">
                            	<div class="admin_atatic_chart" id="citytj" style="width:500px;height:300px; margin:0 auto"></div>
                            </td>
                        </tr>
                        <tr>
                        	<td>	 
                        	   <div class="admin_atatic_chart" id="salarytj" style="width:500px;height:300px; margin:0 auto"></div>
                            </td>

                            <td class="admin_atatic_chart_tdbor"> 
                        	   <div class="admin_atatic_chart" id="edutj" style="width:500px;height:300px; margin:0 auto"></div>
                            </td>
                        </tr>
                        <tr>
                        	<td>	 
                        	   <div class="admin_atatic_chart" id="exptj" style="width:500px;height:300px; margin:0 auto"></div>
                            </td>
...
$_smarty_tpl->tpl_vars['job1list']->_loop = true;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['foo']['index']++;
if ($_smarty_tpl->getVariable('smarty')->value['foreach']['foo']['index']<7) {
