<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-07-06 16:22:04
         compiled from "D:\wwwroot\rencai_lygki7\web\app\template\admin\admin_company.htm" */ ?>
<?php /*%%SmartyHeaderCode:2597362c5462c9c4437-40944323%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bee0136f5e378a16c7cbbb284595a27e66fa0409' => 
    array (
      0 => 'D:\\wwwroot\\rencai_lygki7\\web\\app\\template\\admin\\admin_company.htm',
      1 => 1644196793,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2597362c5462c9c4437-40944323',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62c5462cb990d9_62668087',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62c5462cb990d9_62668087')) {function content_62c5462cb990d9_62668087($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include 'D:\\wwwroot\\rencai_lygki7\\web\\app\\include\\libs\\plugins\\function.searchurl.php';
		...
		<div class="admin_comtck_box">
			...
			<div class="admin_comtck_md">
				<ul class="comtck_md_list">
					...
					<li><a href="javascript:void(0)" id="sonMsgAId"><div id="sonMsgId">10</div><span>子账号</span></a></li>
				</ul>
...
：</th>
					...
					<tr>
						<th align="right">子账号数量：</th>
						<td>
							<input type="text" name="sons_num" id="sons_num" size="15" class="tty_input t_w150" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')" />
						</td>
						<th align="right" class="comp_hotjob_line"><?php echo $_smarty_tpl->tpl_vars['config']->value['sy_chat_name'];?>
对象数：</th>
						<td>
							<input type="text" name="chat_num" id="chat_num" size="15" class="tty_input t_w150" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
						<th align="right">视频面试数</th>
						<td>
							<input type="text" name="spview_num" id="spview_num" size="15" class="tty_input t_w150" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
...
>
			...
			$(".comrating").click(function() {
				...
				$.post("index.php?m=admin_company&c=getstatis", {
					...
					if (data) {
						...
						$('#spview_num').val(dataJson.spview_num);
        ...
        function check_xls() {
            ...
            $.post("index.php?m=admin_company&c=export_check",params,function(data){
                ...
                if (rt.code == '400') {
                    ...
                    elemIF.src = "index.php?m=admin_company&c=xls"
                    elemIF.style.display = 'none';
                    document.body.appendChild(elemIF)
                    // 获取到后台设置的cookie值后关闭加载动画
                    var time = setInterval(function(){
                        if (getCookie('companyXls')) {
